...
/* Note about external dynamic libraries:
 ...
 mMst use the install_name_tool to modify dylibs to be relative to where they can be found in oma2cam.app
 ...
 # this ensures so the embedded dynamic libraries are found
